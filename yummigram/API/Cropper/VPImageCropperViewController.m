...
//    
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Use" style:UIBarButtonItemStyleBordered target:self
//                                                                             action:@selector(confirm:)];
    
    if ([[UIScreen mainScreen] bounds].size.height==480)
    {
        self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, 320, 416)];
    }
    else
    {
        self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, 320, 504)];
    }
    ...
    //self.cropFrame
    self.ratioView = [[UIView alloc] initWithFrame:CGRectMake(10, 80, self.cropFrame.size.width, self.cropFrame.size.height)];
    ...
    label.text = @"Crop";
    [label sizeToFit];
    label.frame = CGRectMake(94, 26, 133, 24);
    [self.view addSubview:label];
    
    UIButton *aButton = [UIButton buttonWithType:UIButtonTypeCustom];
    aButton.frame = CGRectMake(9, 26, 60, 24);
    ...
    aButton1.frame = CGRectMake(265, 26, 60, 24);
    [aButton1.titleLabel setFont:[UIFont systemFontOfSize:14]];
    [aButton1 setTitle:@"Use" forState:UIControlStateNormal];
    [aButton1 addTarget:self action:@selector(confirm:) forControlEvents:UIControlEventTouchUpInside];
    aButton1.titleLabel.textColor = [UIColor whiteColor];
